...
public class FinancialMeansFragment extends Fragment {
    ...
    {
        // todo שיימחק המנעול ואי אפשר להשתמש עד שיקנה את אותו כוח (בנתיים טוסט) אחכ יהיה בו את הכמות טעינה שלו
        int level = 2; // get level
        if(level>=2) {
            TextView tvLock = view.findViewById(R.id.tvLock2);
            tvLock.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
